...
const SortingChart = ({ steps, algorithm }) => {
	...
	useEffect(() => {
		...
		console.log(`Animation interval for ${algorithm}: ${intervalDuration}ms (array length: ${arrayLength})`);
		...
		<Box mt={4}>
			<ResponsiveContainer width="100%" height={200}>
				<BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
					...
					<Bar
						dataKey="value"
						fill={currentStep === steps.length - 1 ? "#e53e3e" : "#3182ce"}
